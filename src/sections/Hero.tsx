...
function Hero() {
  return (
    <section className="md:gap -0 relative mt-4 flex h-fit max-w-7xl flex-col items-center gap-10 px-8 sm:gap-16 md:my-0 md:h-[85vh] md:flex-row lg:px-12 xl:m-auto xl:gap-0 xl:overflow-hidden">
      ...
      <div className="md:w-3/6 xl:mb-12 xl:overflow-hidden">
        ...
        <img
          ...
          src={HeroImage}
          alt="A woman happy using Kobodrop"
        />
      </div>
    </section>
  );
